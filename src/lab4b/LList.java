...
/** Source codse example for "A Practical Introduction to Data
...
protected DLink<E> head;        // Pointer to list header
protected DLink<E> tail;        // Pointer to last element in list 
